    ...
    return(
        <div className="about-container">
            <div className="about-content">
                ...
                -<span>Bookclub</span>: Find others that what to read the same book and join a book club where you can virtually meetup and talk about it!<br/>
                -<span>Podcasts</span>: Continuing to build and what we have, we will try and implemnt audio into on media library.<br/>
